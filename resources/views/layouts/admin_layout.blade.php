        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="{{ route('home') }}">
                ...
                <div class="sidebar-brand-text mx-3">
                    <img width="100%" src="{{ URL::asset('img/umas_authentic_kitchen.png') }}" />
                </div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('kitchen.index') }}">
                    ...
                    <span>Kitchen Items</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('contact_info') }}">
                    <i class="fas fa-fw fa-chart-area"></i>
                    <span>Contact Page Info</span></a>
            </li>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ URL::asset('admin/img/undraw_profile_1.svg') }}" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ URL::asset('admin/img/undraw_profile_2.svg') }}" alt="...">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        <img class="rounded-circle" src="{{ URL::asset('admin/img/undraw_profile_3.svg') }}" alt="...">
